...
export default function Relatorios() {
  ...
  const programReports = useMemo(() => {
    const accountsByProgramId = new Map<string, typeof accounts>();
    ...
    const salesByProgramName = new Map<string, typeof filteredSales>();
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 bg-success-light rounded-lg">
                  ...
                  <p className="text-sm">
                    {[...ownerReports].sort((a, b) => b.roi - a.roi)[0]?.ownerName} apresenta o
                    melhor ROI ({[...ownerReports].sort((a, b) => b.roi - a.roi)[0]?.roi.toFixed(1)}
                    %)
                  </p>
                </div>
