...
- [x] **Step 1: Write the RED assertions**
...
- [x] **Step 2: Implement skill normalization**
...
- [x] **Step 3: Implement completion validation**
...
- [x] **Step 4: Verify GREEN and security assertions**
...
- [x] **Step 5: Commit the schema extension**
...
- [x] **Step 1: Write RED tests for the five routing outcomes**
...
- [x] **Step 2: Implement deterministic correlation**
...
- [x] **Step 3: Wire monthly generation**
...
- [x] **Step 4: Verify JSON generation**
...
- [x] **Step 5: Commit the aggregator**
...
- [x] **Step 2: Implement the section with existing primitives**
...
- [x] **Step 3: Extend dashboard types and legacy behavior**
...
- [x] **Step 4: Add dashboard integration assertions**
...
- [x] **Step 1: Add an integration fixture for resolved/completed pairing**
...
- [x] **Step 2: Keep event-log’s allowlist and test isolation**
...
- [x] **Step 3: Regenerate and inspect the public artifact**
...
- [x] **Step 4: Run the full router verification**
