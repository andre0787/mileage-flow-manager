# Task Card — Blueprint v4.0 P1: Migração do domínio dashboard (RTK Query)
...
## Objetivo
Migrar o domínio **dashboard** para `src/features/dashboard/` usando RTK Query
...
## Critérios de aceite
- [ ] Hooks do domínio dashboard migrados para RTK Query em `src/features/dashboard/`.
