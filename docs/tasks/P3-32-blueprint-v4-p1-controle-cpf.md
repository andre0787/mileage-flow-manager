# Task Card — Blueprint v4.0 P1: Migração do domínio controle-cpf (RTK Query)
...
## Objetivo
Migrar o domínio **controle-cpf** para `src/features/controle-cpf/` usando RTK Query
...
## Critérios de aceite
- [ ] Hooks do domínio controle-cpf migrados para RTK Query em `src/features/controle-cpf/`.
