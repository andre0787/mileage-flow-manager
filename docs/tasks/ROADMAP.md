...
| [P1-12](P1-12-skill-small-model-execution.md) | Skill repo-local `small-model-execution` | pending |

### 🔵 P1-B — Testes e guardrails com sinal real

| Card | Título | Estado |
|------|--------|--------|
| [P1-13](P1-13-typecheck-script.md) | `npm run typecheck` no package.json + CI | review 🔎 |
...
| [P1-17](P1-17-invariantes-financeiras.md) | Invariantes financeiras + reversais | pending |
| [P1-18](P1-18-e2e-estabiliza.md) | E2E: eliminar `waitForTimeout`, separar smoke/integração | pending |
