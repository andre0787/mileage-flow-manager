# Task Card — Blueprint v4.0 P1: Migração do domínio simulador-venda (RTK Query)
...
## Objetivo
Migrar o domínio **simulador-venda** para `src/features/simulador-venda/` usando RTK Query
...
## Critérios de aceite
- [ ] Hooks do domínio simulador-venda migrados para RTK Query em `src/features/simulador-venda/`.
