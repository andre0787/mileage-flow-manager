...
const EXCLUDE_DIRS = new Set(["node_modules", ".git", ".worktrees", ".opencode", ".pi", ".pi-subagents", ".superpowers", ".agents", ".zcode", ".freebuff", "test-results", "playwright-report", "dist", "tests"]);
