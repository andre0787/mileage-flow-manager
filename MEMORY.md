...
| Item | Arquivos | Status |
|------|----------|--------|
| 2.1 Dashboard colapsável | `src/pages/Dashboard.tsx` | 🔴 |
| 2.2 Data density tiers (variantes MetricCard) | `src/components/MetricCard.tsx` | 🔴 |
| 2.3 EmptyState component | `src/components/EmptyState.tsx` | 🔴 |
| 2.4 Empty states em Dashboard | `src/pages/Dashboard.tsx` | 🔴 |
| 2.5 Empty states em Entradas | `src/pages/Entradas.tsx` | 🔴 |
| 2.6 Empty states em Vendas | `src/pages/Vendas.tsx` | 🔴 |
| 2.7 Empty states em Clientes | `src/pages/Clientes.tsx` | 🔴 |
| 2.8 Empty states em Contas | `src/pages/Contas.tsx` | 🔴 |
| 2.9 Validação: build + lint + E2E | — | 🔴 |
...
| 3.3 JetBrains Mono + font swap | `index.html` | 🔴 |
| 3.4 Transições de página (View Transitions API) | `src/index.css`, `src/App.tsx` | 🔴 |
...
- Confetti: `canvas-confetti` (já disponível no npm) — import dinâmico
